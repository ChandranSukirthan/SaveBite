    ...
    <div style={{ minHeight: "100vh", background: "var(--grey-100, #f4f4f4)", fontFamily: "var(--font-family, sans-serif)" }}>
      <header style={{ background: "var(--black, #0f0f0f)", color: "white", padding: "16px 24px", display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: "3px solid var(--yellow, #f5c518)" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          ...
          <span style={{ background: "var(--yellow, #f5c518)", color: "var(--black, #0f0f0f)", fontSize: "11px", fontWeight: 800, padding: "2px 8px", borderRadius: "12px", marginLeft: "6px" }}>Admin Portal</span>
        </div>
      ...
      <main style={{ maxWidth: "1000px", margin: "40px auto", padding: "0 24px" }}>
        <div style={{ background: "white", borderRadius: "16px", padding: "32px", border: "1.5px solid var(--grey-200, #e0e0e0)", boxShadow: "0 4px 16px rgba(0,0,0,0.04)" }}>
          <h2 style={{ fontSize: "24px", fontWeight: 800, color: "var(--black, #0f0f0f)", marginBottom: "8px" }}>Administrator Control Center</h2>
          <p style={{ color: "var(--grey-600, #555555)", marginBottom: "24px" }}>Authentication verified successfully! You are logged in as Admin.</p>
          ...
          <div style={{ background: "var(--grey-100, #f4f4f4)", borderRadius: "12px", padding: "20px", border: "1px solid var(--grey-200, #e0e0e0)" }}>
            ...
            <p style={{ fontSize: "14px", color: "var(--grey-600, #555555)" }}>Admin authentication and route guard active. Milestone 21 (Admin Dashboard) will introduce approval workflow and user management.</p>
          </div>
        </div>
      </main>
    </div>
